...
const PRACTITIONERS: Practitioner[] = [
  {
    id: "p-1",
    name: "সুন্নাহলাইফ শারঈ কনসালটেশন বোর্ড",
    title: "হেড অফিস ও প্রধান শারঈ চেম্বার",
    qualification: "দাওরায়ে হাদীস, তাখাসসুস ফিল ফিকহ ও সহীহ রুকইয়াহ বিশেষজ্ঞ প্যানেল",
    location: "ঢাকা, বাংলাদেশ",
    chamberAddress: "ঢাকা, বাংলাদেশ (সরাসরি চেম্বার ও কনসালটেশন)",
    experience: "১০+ বছর",
    isVerified: true,
    services: ["সরাসরি চেম্বার সেশন", "ইন-পারসন রুকইয়াহ", "জটিল সমস্যা পর্যবেক্ষণ"],
    phone: SITE_CONFIG.raqiWhatsAppNumber,
  },
  {
    id: "p-2",
    name: "অনলাইন ও দূরবর্তী রুকইয়াহ হেল্পডেস্ক",
    title: "সারাদেশ ও প্রবাসী ভাই-বোনদের পরামর্শ টিম",
    qualification: "রুকইয়াহ শারইয়্যাহ ও সাইকো-স্পিরিচুয়াল গাইডেন্স বিশেষজ্ঞ",
    location: "অনলাইন (সারাদেশ ও প্রবাসী)",
    chamberAddress: "অনলাইন ভিডিও ও অডিও কনসালটেশন",
    experience: "৮+ বছর",
    isVerified: true,
    services: ["অনলাইন কনসালটেশন", "সেলফ-রুকইয়াহ মনিটরিং", "জরুরি গাইডেন্স"],
    phone: SITE_CONFIG.raqiWhatsAppNumber,
  },
  {
    id: "p-3",
    name: "নারী ও পরিবার সুরক্ষা সেল",
    title: "নারীদের বিশেষ শারঈ কেয়ার ও কাউন্সেলিং",
    qualification: "আলিমাহ ও মহিলা রুকইয়াহ সহায়ক প্যানেল (মাহরামের উপস্থিতিতে)",
    location: "ঢাকা ও অনলাইন",
    chamberAddress: "সম্পূর্ণ শারঈ পর্দা ও মাহরামের তত্ত্বাবধানে",
    experience: "৭+ বছর",
    isVerified: true,
    services: ["নারীদের বিশেষ মাসআলা", "শিশুদের হিফয ও বদনজর", "পারিবারিক কাউন্সেলিং"],
    phone: SITE_CONFIG.raqiWhatsAppNumber,
  },
];
